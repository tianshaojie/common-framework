...
public class StringConverters {
  ...
  public static StringConverterFactory getCommonFactory() {
    ...
    factory.setConverter(Integer.class, CONVERT_TO_INTEGER).setConverter(Byte.class, CONVERT_TO_BYTE).setConverter(Short.class, CONVERT_TO_SHORT)
        .setConverter(Long.class, CONVERT_TO_LONG).setConverter(Float.class, CONVERT_TO_FLOAT).setConverter(Double.class, CONVERT_TO_DOUBLE)
        .setConverter(Boolean.class, CONVERT_TO_BOOLEAN).setConverter(int.class, CONVERT_TO_INTEGER).setConverter(byte.class, CONVERT_TO_BYTE)
        .setConverter(short.class, CONVERT_TO_SHORT).setConverter(long.class, CONVERT_TO_LONG).setConverter(float.class, CONVERT_TO_FLOAT)
        .setConverter(double.class, CONVERT_TO_DOUBLE).setConverter(boolean.class, CONVERT_TO_BOOLEAN).setConverter(String.class, CONVERT_TO_STRING);
